...
#include "synapse_msgs/msg/detail/bezier_curve__rosidl_typesupport_fastrtps_c.h"
...
using _BezierCurve__ros_msg_type = synapse_msgs__msg__BezierCurve;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BezierCurve__ros_msg_type * ros_message = static_cast<const _BezierCurve__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _BezierCurve__ros_msg_type * ros_message = static_cast<_BezierCurve__ros_msg_type *>(untyped_ros_message);
  // Field name: time_stop
  {
    cdr >> ros_message->time_stop;
  }
...
static uint32_t _BezierCurve__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_synapse_msgs__msg__BezierCurve(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = synapse_msgs__msg__BezierCurve;
    is_plain =
      (
...
static size_t _BezierCurve__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_synapse_msgs__msg__BezierCurve(
...
static message_type_support_callbacks_t __callbacks_BezierCurve = {
  "synapse_msgs::msg",
  "BezierCurve",
...
static rosidl_message_type_support_t _BezierCurve__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BezierCurve,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, synapse_msgs, msg, BezierCurve)() {
  return &_BezierCurve__type_support;
}
